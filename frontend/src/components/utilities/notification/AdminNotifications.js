...
import { FiPlus, FiEdit, FiTrash2, FiUsers, FiRefreshCw, FiCheck, FiX, FiChevronDown, FiChevronRight, FiBell, FiCopy, FiSmartphone } from 'react-icons/fi';
import api from '../../../api';
import QueryBuilder from './QueryBuilder';
import NotificationSchedule from './NotificationSchedule';
import SendNotification from './SendNotification';
import PushSubscribers from './PushSubscribers';
  ...
  return (
    <div className="admin-notifications settings-card">
      ...
      <div className="settings-tabs">
        ...
        <button 
          className={`settings-tab ${activeSection === 'subscribers' ? 'active' : ''}`} 
          onClick={() => setActiveSection('subscribers')}
        >
          <FiSmartphone size={14} style={{ marginRight: '4px' }} />
          Push Subscribers
        </button>
      </div>
