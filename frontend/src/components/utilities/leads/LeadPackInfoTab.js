    ...
    <div style={{ display: 'flex', gap: '24px' }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        <p style={{ fontWeight: 'bold' }}>
          It is the responsibility of the manager to inform the lead team if their agent is eligible for this.
        </p>
        ...
        <p>
          1st time VIP agents add 5k to their managers' ALP ranking within allotment groups.
        </p>
        <p>
          Any VIP agent also adds their referral sales to their direct manager (as listed on the home office VIP report). 
