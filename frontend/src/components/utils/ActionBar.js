...
const ActionBar = ({ selectedCount, totalCount, entityName = "people", archivedView = false, leftContent, children }) => {
  ...
  return (
    <div className="action-bar" ref={actionBarRef}>
      <div className="selected-count">{leftContent !== undefined ? leftContent : displayText}</div>
