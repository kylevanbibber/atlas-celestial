...
const RightDetails = (props) => {
  ...
  // Animation effect - slide in when component mounts, lock background scroll
  useEffect(() => {
    // Lock the actual scroll container (.page-content), not body
  ...
  // Check for our special applicant flag
    ...
    detailProps.onStepChange = props.onStepChange;
  }
