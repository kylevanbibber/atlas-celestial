...
const GlobalSearch = ({ theme, toggleTheme, onOpenAgentProfile }) => {
  ...
  const allItems = [
    ...
    // Production Sections
    { category: 'Production', label: 'Activity & Goals', icon: <FiCheckSquare />, path: '/production?section=activity-goals', show: true,
    ...
    { category: 'Recruiting', label: 'Codes & VIPs', icon: <FiList />, path: '/recruiting?section=vips', show: true,
    ...
    { category: 'Resources', label: 'Refs Collected', icon: <FiUserPlus />, path: '/resources?active=refs', show: true,
      keywords: ['referrals', 'references', 'contacts', 'refs collected'] },
    { category: 'Resources', label: 'Ref Sales', icon: <FiTrendingUp />, path: '/resources?active=ref-sales', show: true,
      keywords: ['ref sales', 'referral sales', 'sales', 'monthly', 'team'] },
    ...
    { category: 'Resources', label: 'Feedback & Updates', icon: <FiMessageSquare />, path: '/resources?active=feedback', show: true,
      keywords: ['bug', 'report', 'feature', 'request', 'issue', 'problem', 'suggestion', 'updates', 'changelog', 'whats new', 'release notes'] },
    ...
    { category: 'Settings', label: 'Hierarchy', icon: <FiUserPlus />, path: '/utilities?section=hierarchy', show: true,
      keywords: ['team', 'upline', 'downline', 'organization', 'structure', 'leader', 'agents', 'rga', 'mga', 'ga', 'sa', 'agt'] },
  ...
  const getFilteredItems = () => {
    if (query.trim()) {
      ...
      const agentItems = agentResults.map(agent => ({
        ...
        icon: agent.profpic 
          ? <img src={agent.profpic} alt="" className="global-search-agent-pic" /> 
          : <FiUser />,
        isAgent: true,
        agentData: {
          ...agent,
