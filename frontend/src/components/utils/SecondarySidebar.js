...
/**
 * Reusable secondary sidebar component for section navigation
 * Used across production, training, utilities, and other pages
 */
const SecondarySidebar = ({ 
  ...
  // Hide secondary sidebar completely on mobile since we have bottom nav submenu
  if (isMobile) {
    return null;
  }
