...
const Login = () => {
  ...
  const [needsPasswordChange, setNeedsPasswordChange] = useState(false); // Flag for default password users
  const [isRedeemed, setIsRedeemed] = useState(false); // Whether the user already completed initial setup
  ...
  return (
    ...
    <div className="auth-background">
      {showRegister ? (
        <Register
          onBackToLogin={() => { setShowRegister(false); setNeedsPasswordChange(false); setIsRedeemed(false); }}
          id={registerData.id}
