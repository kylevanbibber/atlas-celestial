...
self.addEventListener('push', (event) => {
  try {
    ...
    // Skip silent subscription check pings - don't show any notification
    if (data.silent || (data.data && data.data.type === 'subscription_check')) {
      console.log('🔇 Silent subscription check - skipping notification display');
      return;
    }
